...
const signup = (req, res)=>{
    ...
    if(!req.body.emailInput || req.body.passwordInput.length < 8 || req.body.passwordInput !== req.body.confirmPasswordInput){
            ...
            if(err){
                ...
                bcrypt.hash(req.body.passwordInput, salt, (err, pwdHash)=>{
                    if(err){
                        ...
                        let sqlReq = "INSERT INTO users (email, password) VALUES(?,?)";
                        conn.execute(sqlReq, [req.body.emailInput, pwdHash], (err, result)=>{
                            if(err){
