...
import { deleteQuestion, getQuestion, postQuestion } from './controllers/questionController.js';
import { deleteTests, getTests, postTests } from './controllers/testController.js';
...
router.delete('/tests/:id', checkToken, access.level2, deleteTests);
...
router.delete('/questions/:id', checkToken, access.level2, deleteQuestion);
