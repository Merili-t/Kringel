"use strict";
document.querySelectorAll('.guide-description').forEach(description => {
...
document.querySelectorAll('.expand-arrow').forEach(arrow => {
    arrow.addEventListener('click', function () {
        ...
        const description = section === null || section === void 0 ? void 0 : section.querySelector('.guide-description');
